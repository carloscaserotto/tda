...
function gatherData(){
    ...
    console.log(chart_minutos)
    console.log(chart_minutos.value)
    console.log(chart_ppmh2.value)
...
function graficar(minutos,ppmh2,max_y_value){
    ...
    function done(){
        ...
        let chart_minutos = document.getElementById('pdf_minutos');
        let chart_ppmh2 = document.getElementById('pdf_ppmh2');
...
function populateInfo(){
    ...
    // Elegir los comentarios
    let comentario1 = document.getElementById("comentario1");
    let comentario1_index = comentario1.selectedIndex;
    let comentario1_choose = comentario1.options;
    document.getElementById("pdf_comentario1").value = comentario1_choose[comentario1_index].text;
    let comentario2 = document.getElementById("comentario2");
    let comentario2_index = comentario2.selectedIndex;
    let comentario2_choose = comentario2.options;
    document.getElementById("pdf_comentario2").value = comentario2_choose[comentario2_index].text;
    let comentario3 = document.getElementById("comentario3");
    let comentario3_index = comentario3.selectedIndex;
    let comentario3_choose = comentario3.options;
    document.getElementById("pdf_comentario3").value = comentario3_choose[comentario3_index].text;
    //for (let option of document.getElementById('comentario').options)
    //{
    //    if (option.selected) {
    //        selected.push(option.value);
    //    }
    //}
    //document.getElementById("pdf_comentario").value = selected;
