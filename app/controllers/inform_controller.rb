class InformController < ApplicationController
    ...
    def show_chart
        ...
        InformMailer.with(inform: @user).new_inform_email.deliver_later
    end
    ...
    def pdf
        ...
        @conclusion1 = params[:comentario1] #"Perfil fermentativo normal"
        @conclusion2 = params[:comentario2] #"Perfil fermentativo normal"
        @conclusion3 = params[:comentario3] #"Perfil fermentativo normal"
      ...
      #                  :cell_style => { :font => "Times-Roman", :size => 8,:align => :center })
        ...
        pdf.text "#{@conclusion1}", size: 12, style: :bold, align: :center
        pdf.move_cursor_to 180
        pdf.text "#{@conclusion2}", size: 12, style: :bold, align: :center
        pdf.move_cursor_to 160
        pdf.text "#{@conclusion3}", size: 12, style: :bold, align: :center
